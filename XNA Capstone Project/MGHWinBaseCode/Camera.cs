...
namespace CameraViewer
{
    public class Camera 
    {
        ...
        public          Camera()
        {
            position              = new Vector3(-27.5f, 0.9f, -25.0f);
            view                  = new Vector3(-27.5f, 0.9f, -0.5f);
        ...
        //82 y=-31 x=-15 col=18 row=2 ytop=-31 ybottom=27 xleft=-32 xright=32
        ...
        public void UpdatePositionAndView(Vector3 direction, float speed, List<List<int>> boxnumlist)
        {
            Vector3 temp;
            ...
            int x2 = (int)x1, y2 = (int)y1;
            //if (!sprite.collision(x1, y1, radius))
            //{
                temp.X = position.X + direction.X;
                temp.Z = position.Z + direction.Z;
            //}
        ...
        public void Move(float speed, List<List<int>> boxnumlist)
        {
            ...
            UpdatePositionAndView(unitLook, speed, boxnumlist);
        }
        ...
        private void UpdateView(float rotationAmount, Vector3 direction)
        {
            ...
            const float LOWER_LIMIT = -10.0f; const float UPPER_LIMIT = 15.0f;
        ...
        public void Strafe(float speed, List<List<int>> boxnumlist)
        {
            ...
            UpdatePositionAndView(right, speed, boxnumlist);
        }
    }
}